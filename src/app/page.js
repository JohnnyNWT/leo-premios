...
export default function Home() {
  return (
    <div className="h-screen flex items-center flex-col">
      ...
      <div className="w-1/3 h-full absolute top-16 flex flex-col gap-1 rounded-t-3xl bg-[#E4E4E4]">
        ...
        <div className="flex flex-col gap-2" id="container-rifas">
          ...
          <div className="px-3" id="rifa-golf">
          ...
          <div className="bg-white mx-3 p-2 rounded-lg flex items-center" id="rifa-bombox">
          ...
          <div className="bg-white mx-3 p-2 rounded-lg flex items-center" id="rifa-bombox">
            <img src="/img/crf.jpg" alt="Ação Bombox" className="w-24 h-28 rounded-lg" />
