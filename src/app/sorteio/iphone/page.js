        ...
        <div className="flex flex-col gap-2" id="container-rifas">
          <div className="mx-3 mt-3 cursor-pointer shadow-xl" id="rifa-golf">
            ...
            <div className="bg-white rounded-b-lg">
              <div className="p-2">
                <h2 className="font-sans text-lg font-medium text-[#202020]">IPHONE 11 OU R$1.200,00 NA CONTA</h2>
                <p className="text-sm font-light text-[#000000B3]">Imagina ganhar um Iphone 11 com apenas 0,01 centavos?</p>
              </div>
            </div>
          </div>
        </div>
